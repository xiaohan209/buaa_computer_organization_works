...
LAB104:    memcpy(t35, t9, 8);

LAB105:    memset(t67, 0, 8);
    t49 = (t35 + 4);
    t69 = *((unsigned int *)t49);
    t70 = (~(t69));
    t71 = *((unsigned int *)t35);
...
LAB138:    xsi_set_current_line(42, ng0);
...
LAB110:    if (*((unsigned int *)t17) < *((unsigned int *)t16))
        goto LAB109;
...
LAB129:    if (*((unsigned int *)t75) > *((unsigned int *)t74))
        goto LAB128;

LAB127:    *((unsigned int *)t81) = 1;
...
LAB137:    xsi_set_current_line(39, ng0);

LAB140:    xsi_set_current_line(40, ng0);
    t108 = (t0 + 2008U);
    t125 = *((char **)t108);
    t108 = (t0 + 2568);
    xsi_vlogvar_wait_assign_value(t108, t125, 0, 0, 32, 0LL);
...
extern void work_m_00000000001094937110_1095592158_init()
{
	static char *pe[] = {(void *)Always_32_0};
	xsi_register_didat("work_m_00000000001094937110_1095592158", "isim/datapath_isim_beh.exe.sim/work/m_00000000001094937110_1095592158.didat");
